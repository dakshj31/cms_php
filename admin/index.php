        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <?php  $post_count =  count_records(get_all_user_posts()); ?>
...
<?php $comment_count= count_records(get_all_posts_user_comments());?>
<div class='huge'><?php echo $comment_count = recordCount('comments'); ?></div>
 ...
 <?php $category_count= count_records(get_all_posts_user_comments());?>
